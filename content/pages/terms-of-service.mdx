...
description: Terms of service for ShipAny Teamplate Two
created_at: 2025-10-24
---

## Introduction and Acceptance of Terms

Welcome to **ShipAny Teamplate Two**, a NextJS boilerplate designed for building AI SaaS startups quickly and efficiently. By accessing or using our service, you agree to be bound by these Terms of Service. If you do not agree with any of these terms, please do not use our service.

## Use of the Service

ShipAny Teamplate Two provides users with a comprehensive platform to build and launch AI SaaS startups using our pre-built templates and infrastructure. You agree to use the service in accordance with all applicable local, state, national, and international laws and regulations.
...
All content provided through ShipAny Teamplate Two, including but not limited to templates, code, infrastructure setup, and documentation, is protected under copyright law. The copyright owner of ShipAny Teamplate Two is **shipany.ai**.

- You acknowledge that you do not own the underlying technology or intellectual property that makes up the ShipAny Teamplate Two service, and you agree to respect the intellectual property rights of shipany.ai and any third parties.
- While you retain ownership of your custom implementations and modifications, the core ShipAny Teamplate Two platform and templates remain the property of shipany.ai.

## Prohibited Activities

You agree not to engage in any of the following prohibited activities while using ShipAny Teamplate Two:

- Unauthorized access to or distribution of our proprietary code and templates
- Reselling or redistributing ShipAny Teamplate Two templates without authorization
...
ShipAny Teamplate Two collects the following types of data:
...
For more details on data collection practices, please refer to our separate [Privacy Policy](https://shipany.site/privacy-policy).
...
If you have any questions about these Terms, please contact us at [support@shipany.site](mailto:support@shipany.site).

---

By using ShipAny Teamplate Two, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. Thank you for choosing ShipAny Teamplate Two!
