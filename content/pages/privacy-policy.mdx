...
description: Privacy policy for ShipAny Teamplate Two
created_at: 2025-10-24
---

## Introduction

Welcome to ShipAny Teamplate Two, the **NextJS Boilerplate** designed to help you build AI SaaS startups quickly and efficiently. At ShipAny Teamplate Two, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using ShipAny Teamplate Two:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use ShipAny Teamplate Two, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access ShipAny Teamplate Two, such as device type, operating system, and browser type.
...
**Copyright Owner**: [shipany.ai](https://shipany.ai)
**Email**: [support@shipany.site](mailto:support@shipany.site)

By using ShipAny Teamplate Two, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
